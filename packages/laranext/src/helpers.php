...
if (! function_exists('vite_tags')) {
     ...
     * @throws \Exception
     */
    function vite_tags($manifestDirectory = '', $port = 3000, $live = false)
    {
        return app(Vite::class)($manifestDirectory, $port, $live);
    }
}

if (! function_exists('vite_tags_live')) {
    /**
     * Get the path to a versioned vite file.
     *
     * @param  string  $path
     ...
     * @throws \Exception
     */
    function vite_tags_live($manifestDirectory = '', $port = 3000, $live = true)
    {
        return app(Vite::class)($manifestDirectory, $port, $live);
    }
}
